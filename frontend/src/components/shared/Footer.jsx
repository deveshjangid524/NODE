...
const decreament = () => {
  ...
  return (
    <div className='fixed bottom-0 lef-0 right-0 bg-[#262626] p-2 h-16 w-full flex justify-around'>
      ...
      <button onClick={()=> navigate('/tables')} className='flex items-center justify-center text-[#ababab] w-[200px]'><MdTableBar className='inline mr-2' size={20}/>Tables</button>
      ...
      <button className='flex items-center justify-center text-[#ababab] w-[200px]'><CiCircleMore className='inline mr-2' size={20}/>More</button>
        ...
        <button onClick={ openModal} className='absolute bottom-6 bg-[#F6B100] text-[#f5f5f5] items-center rounded-full p-3'><BiSolidDish size={30}/></button>
